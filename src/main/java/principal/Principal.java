...
public class Principal {
    ...
    private final String API_KEY = "&apikey=48b3fc4d";

    public void exibeMenu(){
        System.out.println("Digite o nome da série para leitura: ");
        ...
        for (int i = 1; i <= dados.totalEmporadas() ; i++) {
...
//        for (int i = 0; i < dados.totalEmporadas(); i++) {
